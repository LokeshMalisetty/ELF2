...
public class TricentisHomePage extends BaseClass{
	...
	public WebElement getMotorcycleNavBar() {
		return motorcycleNavBar;
	}
	...
	private WebElement motorcycleNavBar;


	public static void navigateToAutomobile() {
		driver.findElement(By.id("nav_motorcycle")).click();
		MCEnterVehicleData enterVehicleData = new MCEnterVehicleData(driver);
